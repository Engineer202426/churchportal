...
if (empty($booksToDisplay)) {
  ...
  header("Location: ./guestlearningA.php?page=1");
  exit;
}
...
function addBook($title, $author) {
  ...
  $contentFilePath = "./Guest/$newContentFile";
  ...
  header("Location: ./guestlearningA.php?page=$bookNumber");
  exit;
}
...
function removeBook() {
  ...
  header("Location: ./guestlearningA.php?page=" . max(1, $lastPage));
  exit;
}
...
<body>
  ...
  <div class="container">
    ...
    <div class="book-page">
      ...
      <div id="content">
        <?php
        $contentFilePath = "./Guest/$contentFile";
...
function saveEditedContent() {
  ...
  xhr.open("POST", "save_editguest.php?page=<?php echo $currentPage; ?>", true);
  ...
  if (newTitle && newAuthor) {
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "guestlearningA.php", true);
    xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    xhr.onreadystatechange = function () {
